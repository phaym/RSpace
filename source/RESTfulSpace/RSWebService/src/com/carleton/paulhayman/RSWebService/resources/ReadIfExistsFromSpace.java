...
import com.carleton.paulhayman.RSWebService.models.ReadTransaction;

@Path("readIfExists")
public class ReadIfExistsFromSpace {
	...
	public Response postReadTransaction(SpaceEntry entryToRead){	
		...
		ReadTransaction readTransaction = new ReadTransaction(entryToRead, entryTransId, true);
